...
import com.example.team.controller.reward_info.Reward_infoController;
...
public class Reward_infoController {
	...
	public String pay(@ModelAttribute User_rewardDTO dto,HttpSession session){	
	 String userid=(String)session.getAttribute("userid");
	 MemberDTO dto1=memberService.userInfoMember(userid);
	 dto1.setUno(dto1.getUno());
	 dto1.setName(dto1.getName());
